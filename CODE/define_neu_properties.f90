...
do nf = 0, Tdomain%sNeu%n_faces-1
  ...
  if (ngll1 == 5 .and. ngll2==5)  Tdomain%sNeu%nFace(nf)%mat_index = mat_index  
  if (ngll1 == 5 .and. ngll2==8)  Tdomain%sNeu%nFace(nf)%mat_index = 3
  if (ngll1 == 8 .and. ngll2==5)  Tdomain%sNeu%nFace(nf)%mat_index = 4
...
print*,"Neu Speed",Tdomain%sNeu%nParam%speed
