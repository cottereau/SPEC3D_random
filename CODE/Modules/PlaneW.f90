...
!if (rg ==0 .and. nf==40 .and. i==3 .and. j==3) print*,xpt,ypt,zpt
...
!if (rg == 8 .and. nf == 20 .and. i==2 .and. j==2) write(20,*) ctime,vel_i(2,2,1)
...
!if (rg ==38 .and. nf==6 .and. i==3 .and. j==3) write(40,*) Face%Orient,Face%Face_UP,Face%Face_DOWN
!if (rg ==38 .and. nf==6 .and. i==3 .and. j==3) write(50,*) Traction_i(i,j,0)
!if (rg ==38 .and. nf==6 .and. i==3 .and. j==3) write(51,*) Traction_i(i,j,1)
!if (rg ==38 .and. nf==6 .and. i==3 .and. j==3) write(52,*) Traction_i(i,j,2)
...
!if (rg ==38 .and. nf==6 .and. i==3 .and. j==3) write(50,*) Face%Forces_Up(i,j,0),Vfree(i,j,0)/( dt * (Face%MassMat_Up(i,j)+Face%MassMat_Down(i,j)) ), Face%Forces_Down(i,j,0)
!if (rg ==38 .and. nf==6 .and. i==3 .and. j==3) write(51,*) Face%Forces_Up(i,j,1),Vfree(i,j,1)/( dt * (Face%MassMat_Up(i,j)+Face%MassMat_Down(i,j)) ), Face%Forces_Down(i,j,1)
!if (rg ==38 .and. nf==6 .and. i==3 .and. j==3) write(52,*) Face%Forces_Up(i,j,2),Vfree(i,j,2)/( dt * (Face%MassMat_Up(i,j)+Face%MassMat_Down(i,j)) ), Face%Forces_Down(i,j,2)
...
!if (rg==0 .and. nf==12 .and. i==3 .and. j==3) write(41,*) ctime,vel_i(i,j,2)
!if (rg==0 .and. nf==12 .and. i==3 .and. j==3) write(43,*) ctime,Traction_i(i,j,2)  !write(43,*)
!if (rg==0 .and. nf==12 .and. i==3 .and. j==3) write(44,*) ctime,Face%Forces_Up(i,j,2)
  enddo
enddo
!if (nf==13) write(16,*) ctime,Vfree(3,3,2) -  vel_i(3,3,2)
...
Sortie = .false.
if (Sortie) then
!if (rg==1 .and. nf==17) write(10,*) nf,xpt,ypt,zpt
!if (rg==1 .and. nf==17) write(10,*)  Vertex%MassMat_Down
!if (rg==1 .and. nf==17) write(10,*)  Vertex%MassMat_Up
!if (rg==2 .and. nf==27) write(11,*) nf,xpt,ypt,zpt
!if (rg==2 .and. nf==27) write(11,*)  Vertex%MassMat_Down
!if (rg==2 .and. nf==27) write(11,*)  Vertex%MassMat_Up
!if (rg==1 .and. nf==17) write(63,*)  ctime
!if (rg==1 .and. nf==17) write(63,*)  Vfree(0:2)
!if (rg==1 .and. nf==17) write(63,*)  Vertex%MassMat_Down
!if (rg==1 .and. nf==17) write(63,*)  Vertex%MassMat_Up
!if (rg==1 .and. nf==17) write(60,*)  ctime,Traction_i(0)
!if (rg==1 .and. nf==17) write(51,*)  ctime,Traction_i(1)
!if (rg==1 .and. nf==17) write(52,*)  ctime,Traction_i(2)
!if (rg==1 .and. nf==17) write(64,*)  ctime,Vertex%Forces_Up(0)
!if (rg==1 .and. nf==17) write(65,*)  ctime,Vertex%Forces_Up(1)
!if (rg==1 .and. nf==17) write(66,*)  ctime,Vertex%Forces_Up(2)
!if (rg==1 .and. nf==17) write(67,*)  ctime,Vertex%Forces_Down(0)
!if (rg==1 .and. nf==17) write(68,*)  ctime,Vertex%Forces_Down(1)
!if (rg==1 .and. nf==17) write(69,*)  ctime,Vertex%Forces_Down(2)
!if (rg==1 .and. nf==17) write(63,*)  Sigma11,Sigma22,Sigma33
!if (rg==1 .and. nf==17) write(63,*)  Vertex%Btn(0),Vertex%Btn(1),Vertex%Btn(2)

if (rg==2 .and. nf==27) write(73,*)  ctime
if (rg==2 .and. nf==27) write(73,*)  Vfree(0:2)
if (rg==2 .and. nf==27) write(73,*)  Vertex%MassMat_Down
if (rg==2 .and. nf==27) write(73,*)  Vertex%MassMat_Up
if (rg==2 .and. nf==27) write(70,*)  ctime,Traction_i(0)
if (rg==2 .and. nf==27) write(71,*)  ctime,Traction_i(1)
if (rg==2 .and. nf==27) write(72,*)  ctime,Traction_i(2)
if (rg==2 .and. nf==27) write(74,*)  ctime,Vertex%Forces_Up(0)
if (rg==2 .and. nf==27) write(75,*)  ctime,Vertex%Forces_Up(1)
if (rg==2 .and. nf==27) write(76,*)  ctime,Vertex%Forces_Up(2)
if (rg==2 .and. nf==27) write(77,*)  ctime,Vertex%Forces_Down(0)
if (rg==2 .and. nf==27) write(78,*)  ctime,Vertex%Forces_Down(1)
if (rg==2 .and. nf==27) write(79,*)  ctime,Vertex%Forces_Down(2)
!if (rg==2 .and. nf==27) write(73,*)  Sigma11,Sigma22,Sigma33
!if (rg==2 .and. nf==27) write(73,*)  Vertex%Btn(0),Vertex%Btn(1),Vertex%Btn(2)
!if (rg==1 .and. nf==2)    write(60,*) "#############"
!if (rg==1 .and. nf==2)    write(61,*) "#############"
!if (rg==1 .and. nf==2)    write(62,*) "#############"
!if (rg==1 .and. nf==2)    write(63,*) "#############"
!if (zpt==450) write(60,*)  nf,ctime,Traction_i(1)
!if (zpt==450) write(60,*)  nf,ctime,Traction_i(2)
!if (zpt==450) write(61,*)  nf,ctime,Vertex%Forces_Up(0)
!if (zpt==450) write(61,*)  nf,ctime,Vertex%Forces_Up(1)
!if (zpt==450) write(61,*)  nf,ctime,Vertex%Forces_Up(2)
!if (zpt==450) write(62,*)  nf,ctime,Vertex%Forces_Down(0)
!if (zpt==450) write(62,*)  nf,ctime,Vertex%Forces_Down(1)
!if (zpt==450) write(62,*)  nf,ctime,Vertex%Forces_Down(2)
endif
...
!force = (1.-2.*arg**2)*exp(-arg**2)
!force = 0.5*exp(-arg*arg)*(-6.*arg+4.*arg*arg*arg)*pi*f0
force = exp(-arg*arg)*(-6*arg+4*arg*arg*arg)*pi*f0/0.0518882 
!force = exp(-arg*arg)*(-6*arg+4*arg*arg*arg)*pi*f0/ 0.072067273696138
