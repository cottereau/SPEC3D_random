...
real :: MassMat
real, dimension(0:2) :: Forces, Displ, Veloc, Accel, V0!,D0
real, dimension(0:2) :: Forces1, Forces2, Forces3
real, dimension(0:2) :: DumpMass
real, dimension(0:2) :: Veloc1, Veloc2, Veloc3
real, dimension(0:1) :: DumpVx, DumpVy, DumpVz
