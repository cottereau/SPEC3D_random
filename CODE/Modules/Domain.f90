...
logical :: any_PML, curve, any_random, any_FPML,any_aniso,SaveMecaField,TimeReverse 
...
logical, dimension(:), pointer :: Field_Order
logical::replay=.false.
integer :: n_elem_nonPML=0
integer :: PML_GLL_out
real,dimension(:),pointer::Ratios
integer::EnerMat
real,dimension(:,:),pointer::slices
integer,dimension(:,:),pointer::I_elem_inSlices
integer::nbSlices
integer::MaxiSliceSize=50000
end type
