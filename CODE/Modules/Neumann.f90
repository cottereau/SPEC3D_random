...
!if (nf==0 .and. i==2 .and. j==1) print*,'F',xpt,ypt,zpt
...
!if (nf==10 .and. i==3 .and. j==3) write(30,*) ctime, Face%Forces(i,j,0)
!if (nf==10 .and. i==3 .and. j==3) write(31,*) ctime, Face%Forces(i,j,1)
!if (nf==10 .and. i==3 .and. j==3) write(32,*) ctime, Face%Forces(i,j,2)
  enddo
enddo
...
!if(nf==0 .and. i==3) print*,'E',xpt,ypt,zpt
    call Inc_VelocN (Param,xpt,ypt,zpt,ctime,velixn,veliyn,velizn)
...
!if (nf==10 .and. i==3) write(31,*) ctime, Edge%Forces(i,2)
enddo
...
!if (nf==22 .and. rg==11) write(40,*) vel_i(1)
!if (nf==10 .and. rg==13) write(41,*) vel_i(1)
...
!if (nf==21 .and. rg==1) write(10,*) ctime,Vertex%Forces(2)
!if (nf==21 .and. rg==2) write(11,*) ctime,Vertex%Forces(2)
