subroutine compute_GLL(Tdomain,rg)

! Modified by Gaetano Festa 01/02/2005
...
integer ::  ngll, i, ndomains, n_m_dim,rg
...
!!$if ((i==0) .and. (rg==0)) print *, Tdomain%sSubdomain(i)%GLLcx, 'DDDDDDDDDDDDDD',Tdomain%sSubdomain(i)%GLLpolx,'CCCCCCCCCC',Tdomain%sSubdomain(i)%GLLwx,'BBBB',Tdomain%sSubdomain(i)%hTprimex(0,:)
