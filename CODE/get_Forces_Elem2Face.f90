        ...
        select case (i)
         case (0)
            Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                Tdomain%specel(n)%Forces(1:ngll1-2,1:ngll2-2,0,0:2)
            if (Tdomain%sFace(nf)%PML) then
             Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                  Tdomain%specel(n)%Forces1(1:ngll1-2,1:ngll2-2,0,0:2)
             Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                  Tdomain%specel(n)%Forces2(1:ngll1-2,1:ngll2-2,0,0:2)
             Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                  Tdomain%specel(n)%Forces3(1:ngll1-2,1:ngll2-2,0,0:2)
            endif
         case (1)
            Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                Tdomain%specel(n)%Forces(1:ngll1-2,0,1:ngll2-2,0:2)
            if (Tdomain%sFace(nf)%PML) then
             Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                  Tdomain%specel(n)%Forces1(1:ngll1-2,0,1:ngll2-2,0:2)
             Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                  Tdomain%specel(n)%Forces2(1:ngll1-2,0,1:ngll2-2,0:2)
             Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                  Tdomain%specel(n)%Forces3(1:ngll1-2,0,1:ngll2-2,0:2)
            endif
         case (2)
            Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) + &
                                                            Tdomain%specel(n)%Forces(ngllx-1,1:ngll1-2,1:ngll2-2,0:2)
            if (Tdomain%sFace(nf)%PML) then
             Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) + &
                                                              Tdomain%specel(n)%Forces1(ngllx-1,1:ngll1-2,1:ngll2-2,0:2)
             Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) + &
                                                              Tdomain%specel(n)%Forces2(ngllx-1,1:ngll1-2,1:ngll2-2,0:2)
             Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) + &
                                                              Tdomain%specel(n)%Forces3(ngllx-1,1:ngll1-2,1:ngll2-2,0:2)
            endif
         case (3)
            Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) + &
                                                            Tdomain%specel(n)%Forces(1:ngll1-2,nglly-1,1:ngll2-2,0:2)
            if (Tdomain%sFace(nf)%PML) then
             Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) + &
                                                              Tdomain%specel(n)%Forces1(1:ngll1-2,nglly-1,1:ngll2-2,0:2)
             Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) + &
                                                              Tdomain%specel(n)%Forces2(1:ngll1-2,nglly-1,1:ngll2-2,0:2)
             Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) + &
                                                              Tdomain%specel(n)%Forces3(1:ngll1-2,nglly-1,1:ngll2-2,0:2)
            endif
         case (4)
            Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                Tdomain%specel(n)%Forces(0,1:ngll1-2,1:ngll2-2,0:2)
            if (Tdomain%sFace(nf)%PML) then
             Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                  Tdomain%specel(n)%Forces1(0,1:ngll1-2,1:ngll2-2,0:2)
             Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                  Tdomain%specel(n)%Forces2(0,1:ngll1-2,1:ngll2-2,0:2)
             Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) + &
                                                                  Tdomain%specel(n)%Forces3(0,1:ngll1-2,1:ngll2-2,0:2)
            endif
         case (5)
            Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces(1:ngll1-2,1:ngll2-2,0:2) + &
                                                            Tdomain%specel(n)%Forces(1:ngll1-2,1:ngll2-2,ngllz-1,0:2)
            if (Tdomain%sFace(nf)%PML) then
             Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces1(1:ngll1-2,1:ngll2-2,0:2) + &
                                                              Tdomain%specel(n)%Forces1(1:ngll1-2,1:ngll2-2,ngllz-1,0:2)
             Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces2(1:ngll1-2,1:ngll2-2,0:2) + &
                                                              Tdomain%specel(n)%Forces2(1:ngll1-2,1:ngll2-2,ngllz-1,0:2)
             Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) = Tdomain%sFace(nf)%Forces3(1:ngll1-2,1:ngll2-2,0:2) + &
                                                              Tdomain%specel(n)%Forces3(1:ngll1-2,1:ngll2-2,ngllz-1,0:2)
            endif
         end select
    ...
    select case (i)
      case (0)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
           Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(nglly-1-k,j,0,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
           Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(nglly-1-k,j,0,0:2)
           Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(nglly-1-k,j,0,0:2)
           Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(nglly-1-k,j,0,0:2)
           enddo
          enddo
        endif
      case (1)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(ngllz-1-k,0,j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(ngllz-1-k,0,j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(ngllz-1-k,0,j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(ngllz-1-k,0,j,0:2)
           enddo
          enddo
        endif
      case (2)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(ngllx-1,ngllz-1-k,j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(ngllx-1,ngllz-1-k,j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(ngllx-1,ngllz-1-k,j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(ngllx-1,ngllz-1-k,j,0:2)
           enddo
          enddo
        endif
      case (3)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(ngllz-1-k,nglly-1,j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(ngllz-1-k,nglly-1,j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(ngllz-1-k,nglly-1,j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(ngllz-1-k,nglly-1,j,0:2)
           enddo
          enddo
        endif
      case (4)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(0,ngllz-1-k,j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(0,ngllz-1-k,j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(0,ngllz-1-k,j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(0,ngllz-1-k,j,0:2)
           enddo
          enddo
        endif
      case (5)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(nglly-1-k,j,ngllz-1,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(nglly-1-k,j,ngllz-1,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(nglly-1-k,j,ngllz-1,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(nglly-1-k,j,ngllz-1,0:2)
           enddo
          enddo
        endif
    end select
    ...
    select case (i)
      case (0)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
           Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(k,ngllx-1-j,0,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
           Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(k,ngllx-1-j,0,0:2)
           Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(k,ngllx-1-j,0,0:2)
           Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(k,ngllx-1-j,0,0:2)
           enddo
          enddo
        endif
      case (1)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(k,0,ngllx-1-j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(k,0,ngllx-1-j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(k,0,ngllx-1-j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(k,0,ngllx-1-j,0:2)
           enddo
          enddo
        endif
      case (2)
      ...
      case (3)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(k,nglly-1,ngllx-1-j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(k,nglly-1,ngllx-1-j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(k,nglly-1,ngllx-1-j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(k,nglly-1,ngllx-1-j,0:2)
           enddo
          enddo
        endif
      case (4)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(0,k,nglly-1-j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(0,k,nglly-1-j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(0,k,nglly-1-j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(0,k,nglly-1-j,0:2)
           enddo
          enddo
        endif
      case (5)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(k,ngllx-1-j,ngllz-1,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(k,ngllx-1-j,ngllz-1,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(k,ngllx-1-j,ngllz-1,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(k,ngllx-1-j,ngllz-1,0:2)
           enddo
          enddo
        endif
    end select
    ...
    select case (i)
      case (0)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
           Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(nglly-1-k,ngllx-1-j,0,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
           Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(nglly-1-k,ngllx-1-j,0,0:2)
           Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(nglly-1-k,ngllx-1-j,0,0:2)
           Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(nglly-1-k,ngllx-1-j,0,0:2)
           enddo
          enddo
        endif
      case (1)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(ngllz-1-k,0,ngllx-1-j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(ngllz-1-k,0,ngllx-1-j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(ngllz-1-k,0,ngllx-1-j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(ngllz-1-k,0,ngllx-1-j,0:2)
           enddo
          enddo
        endif
      case (2)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(ngllx-1,ngllz-1-k,nglly-1-j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(ngllx-1,ngllz-1-k,nglly-1-j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(ngllx-1,ngllz-1-k,nglly-1-j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(ngllx-1,ngllz-1-k,nglly-1-j,0:2)
           enddo
          enddo
        endif
      case (3)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(ngllz-1-k,nglly-1,ngllx-1-j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(ngllz-1-k,nglly-1,ngllx-1-j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(ngllz-1-k,nglly-1,ngllx-1-j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(ngllz-1-k,nglly-1,ngllx-1-j,0:2)
           enddo
          enddo
        endif
      case (4)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(0,ngllz-1-k,nglly-1-j,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(0,ngllz-1-k,nglly-1-j,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(0,ngllz-1-k,nglly-1-j,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(0,ngllz-1-k,nglly-1-j,0:2)
           enddo
          enddo
        endif
      case (5)
        do j = 1,ngll1-2 
         do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces(j,k,0:2) = Tdomain%sFace(nf)%Forces(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces(nglly-1-k,ngllx-1-j,ngllz-1,0:2)
         enddo
        enddo
        if (Tdomain%sFace(nf)%PML) then
          do j = 1,ngll1-2 
           do k = 1,ngll2-2
         Tdomain%sFace(nf)%Forces1(j,k,0:2) = Tdomain%sFace(nf)%Forces1(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces1(nglly-1-k,ngllx-1-j,ngllz-1,0:2)
         Tdomain%sFace(nf)%Forces2(j,k,0:2) = Tdomain%sFace(nf)%Forces2(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces2(nglly-1-k,ngllx-1-j,ngllz-1,0:2)
         Tdomain%sFace(nf)%Forces3(j,k,0:2) = Tdomain%sFace(nf)%Forces3(j,k,0:2) + &
                                          Tdomain%specel(n)%Forces3(nglly-1-k,ngllx-1-j,ngllz-1,0:2)
           enddo
          enddo
        endif
    end select
