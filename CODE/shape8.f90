...
integer :: n, i_aus, ngll,ngllx,nglly,ngllz,ngll1,ngll2, mat, i,j,k ,ipoint, n_face, nf,ne,nv,n_aus,nf_up,nf_down,Orient
...
if (Tdomain%super_object_type == "P") then ! Plane Wave
  ...
  write (fnamef,"(a,I2.2,a,I3.3)") "PWNormale",rg
...
if (Tdomain%logicD%neumann_local_present) then
  ...
  write (fnamef,"(a,I2.2,a,I3.3)") "NeuNormale",rg
  open (60, file=fnamef, status="unknown", form="formatted")
